<div class="modal">
    <div class="modal-box relative">
        <label for="my-modal-newPlayer" class="btn btn-sm btn-circle absolute right-2 top-2">✕</label>
        <section class="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-inherit">
            <h2 class="text-lg font-semibold text-gray-700 capitalize dark:text-white">store player</h2>
